...
flags.DEFINE_string("vocab_file", "./mnt/bert/uncased_L-12_H-768_A-12/vocab.txt",
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "init_checkpoint", "./mnt/bert/uncased_L-12_H-768_A-12/bert_model.ckpt",
    "Initial checkpoint (usually from a pre-trained BERT model).")

flags.DEFINE_string(
    "output_dir", "./mnt/bert_out/100000/",
    "The output directory where the model checkpoints will be written.")

## Other parameters
flags.DEFINE_string("coqa_train_file", "./mnt/coqa_extractive_gt/coqa-train-v1.0.json",
...
flags.DEFINE_string("quac_train_file", "./mnt/quac_original/train_v0.2.json",
